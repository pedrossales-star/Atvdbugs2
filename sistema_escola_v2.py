...
# Função 25 - Valida um CPF (formato básico: 000.000.000-00)def validar_cpf_formato(cpf):
    """
...
def ranking_turma(alunos):
    ...
    """
    return sorted(alunos, key["nota"]a: a["nome"], reverse=True)
...
def relatorio_final(turma):
    ...
    percentual = len(aprovados) / len(reprovados) * total
